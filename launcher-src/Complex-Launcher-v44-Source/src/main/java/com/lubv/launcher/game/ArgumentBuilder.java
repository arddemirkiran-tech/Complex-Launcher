...
public class ArgumentBuilder {
    public static List<String> buildFullCommand(LaunchContext launchContext, String string) {
        ...
        arrayList.add("-Dminecraft.launcher.version=44.0.0");
    ...
    private static Map<String, String> placeholders(LaunchContext launchContext) {
        ...
        linkedHashMap.put("natives_directory", launchContext.nativesDir.getAbsolutePath());            linkedHashMap.put("launcher_name", "Complex-Launcher");            linkedHashMap.put("launcher_version", "44.0.0");
